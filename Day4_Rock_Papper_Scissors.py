...
def RPS_Game(gamer_choice):
    ...
    if (gamer_choice == "Paper" and computer_choice == "Rock") or \
        ...
        print(f"Your choice is {gamer_choice}, and computer choose {computer_choice}. You win.")
    elif gamer_choice == computer_choice:
        print(f"Both of you have the same choice: {gamer_choice}. Tied.")
    else:
        print(f"Your choice is {gamer_choice}, and computer choose {computer_choice}.Computer Win.")

gamer_choice = input("Welcome to Rock-Paper-Scissors Game.\n To Start, just make a choice: Rock, Paper, or Scissors. ").strip().title()
# Call the function
